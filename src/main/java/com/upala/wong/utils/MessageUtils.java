...
public class MessageUtils {
	...
	public static SmsSingleSenderResult sendMessage(String[] phoneNumbers, String[] con) {
		...
		try {
			SmsSingleSender sender = new SmsSingleSender(FinalVarCommon.APP_ID, FinalVarCommon.APP_KEY);
			result = sender.sendWithParam("86", phoneNumbers[0], FinalVarCommon.TEMPLATE_ID, con,
					FinalVarCommon.SMS_SIGN, "", "");
